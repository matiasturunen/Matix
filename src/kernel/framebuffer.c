...
int framebuffer_init(void) {
	...
	tags[0].proptag = FB_SET_PHYSICAL_DIMESIONS;
	tags[0].value_buffer.fb_screen_size.width = 640;
	tags[0].value_buffer.fb_screen_size.heigth = 480;
	tags[1].proptag = FB_SET_VIRTUAL_DIMENSIONS;
	tags[1].value_buffer.fb_screen_size.width = 640;
	tags[1].value_buffer.fb_screen_size.heigth = 480;
	...
	fbinfo.heigth = tags[0].value_buffer.fb_screen_size.heigth;
	fbinfo.chars_width = fbinfo.width / CHAR_WIDTH;
	fbinfo.chars_height = fbinfo.heigth / CHAR_HEIGHT;
	fbinfo.chars_x = 0;
	fbinfo.chars_y = 0;
	...
	tags[0].value_buffer.fb_screen_size.heigth = 0;
